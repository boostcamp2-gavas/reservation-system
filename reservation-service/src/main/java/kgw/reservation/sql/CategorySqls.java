...
public class CategorySqls {
	...
	public final static String SELECT_BY_NAME ="select id from category where name = :name order by id";
    ...
    public final static String SELECT_ALL = "select id, name from category order by id";
}
