...
public class UserReservationSqls {
	...
	public static final String SELECTAll = "SELECT product.id,product.name,display.display_start,display.display_end, info.general_ticket_count,info.youth_ticket_count,info.child_ticket_count,info.reservation_type " + 
