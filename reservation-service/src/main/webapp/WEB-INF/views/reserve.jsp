                    ...
                    <div class="form_wrap">
                        ...
                        <form class="form_horizontal">
                            <div class="inline_form"> <label class="label" for="name"> <span class="spr_book ico_nessasary">필수</span> <span>예매자</span> </label>
                                <div class="inline_control"> <input type="text" name="name" id="name" class="text" value="${sessionScope.USER.username}" maxlength="17"> </div>
                            </div>
                            ...
                            <div class="inline_form"> <label class="label" for="email">  <span>이메일</span> </label>
                                <div class="inline_control"> <input type="email" name="email" id="email" class="email" value="${sessionScope.USER.email}" maxlength="50"> </div>
                            </div>
...
<script type="text/handlebars-template" id="ticket-template">
    {{#each this}}
    <div class="qty" id="{{ticketId}}" data-pricetype="{{priceType}}">
        ...
        <div class="qty_info_icon">
            <strong class="product_amount"> <span>{{type}}</span> </strong>
            <strong class="product_price" data-price="{{discountPrice}}"> <span class="price">{{pricePretty}}</span> <span class="price_type">원</span> </strong>
            <em class="product_dsc">{{discountPricePretty}}원 ({{discountRate}}% 할인가)</em>
        </div>
    </div>
    {{/each}}
</script>

<script type="text/javascript" src="/resources/dist/reservebundle.js"></script>
