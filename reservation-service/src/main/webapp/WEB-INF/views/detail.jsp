...
<body>
<div id="gavas" data-productid="${productId}"></div>
<div id="container">
        ...
        <div>
            <div class="section_visual">
                <header>
                    ...
                    <a href="/reservations" class="btn_my"> <span title="내 예약">MY</span> </a>
                </header>
            ...
            <div class="section_review_list">
                <div class="review_box">
                    ...
                    <div class="short_review_area">
                        <div class="grade_area">
                            ...
                            <span class="graph_mask"> <em class="graph_value" style="width: ${star}%;"></em> </span>
                ...
                <a class="btn_review_more" href="/details/${productId}/comments" style="display: none;"> <span>예매자 한줄평 더보기</span> <i class="fn fn-forward1"></i> </a>
            </div>
                    ...
                    <div class="detail_area">
                        <div class="detail_info">
                            ...
                            <ul class="detail_info_group">
                                ...
                                <li class="detail_info_lst lazy_section"><strong class="in_tit">[공연정보]</strong>
                                    <ul class="in_img_group">
                                        <li class="in_img_lst"><img alt="" class="img_thumb"
                ...
                <div class="detail_location hide">
                    <div class="box_store_info no_topline">
                        <a href="#" class="store_location" title="지도웹으로 연결">
                            <%--<img id="map" class="store_map img_thumb" alt="map" src="">--%>
                            <%--https://simg.pstatic.net/static.map/image?version=1.1&amp;crs=EPSG:4326&amp;baselayer=bl_vc_bg&amp;exception=xml&amp;scale=2&amp;caller=mw_smart_booking&amp;overlayers=ol_vc_an&amp;center=127.0011948,37.5717079&amp;markers=type,default2,127.0011948,37.5717079&amp;level=11&amp;w=340&amp;h=150--%>
                            <div id="map" style="width:372px;height:150px;"></div>
...
<div id="photoveiwer" class="pop-layer">
    ...
    <li class="list_item" data-comment={{id}}>
        <div>
            <div class="review_area">
                <div class="thumb_area">
                    {{#if fileId}}
                    <a href="#" class="thumb" title="이미지 크게 보기"> <img width="90" height="90" class="img_vertical_top" src="/api/file/{{fileId}}" alt="리뷰이미지"> </a> <span class="img_count">{{fileCount}}</span>
                </div>
                {{else}}
            </div>
            {{/if}}
...
<script id="detailImage-template" type="text/handlebars-template">
    <%--{{#each data}}--%>
