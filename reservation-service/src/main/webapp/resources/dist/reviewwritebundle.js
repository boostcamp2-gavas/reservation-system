...
(function () {
  ...
  if (!this.moment && "function" === 'function') {
    if (module && module.exports) { //Check if the environment is Node.js
      hookMoment(__webpack_require__(0)); //if it is, we have to require it different (without the surrounding Array)
    } else {
      new Promise(function(resolve) { resolve(); }).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(0)]; (function (moment) {
        hookMoment(moment);
