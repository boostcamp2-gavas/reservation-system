...
(function () {
    ...
    var MyReservation = (function () {
        ...
        $.ajax('/api/reservations').then(function (data) {
        ...
        function bindOnCancelBtn() {
            $('.card_item .booking_cancel').on('click', function () {
                ...
                if (type === CARD_TYPE.reserveCancel) {
                    cancelJsonData = {'id': id, 'reservationType': TYPE_NUM};
                    cancelTap = 1;
        ...
        function bindLayerBtn(layer) {
            ...
            $(layer).find('.btn_green').on('click', function () {
                $.ajax({
                    url: '/api/reservations/' + cancelJsonData.id,
                    type: "PUT",
                    contentType: "application/json; charset=UTF-8",
                    data: JSON.stringify(cancelJsonData)
                }).then(function () {
